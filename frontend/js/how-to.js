...
const LESSONS = {
  start: "Welcome to how to use AI Sight. You do not need to sign in to hear this. AI Sight is a talking camera for blind people. The whole camera screen is a button. Hold the screen, speak, then let go. Double tap to start or stop object detection. Family is one group. Emergency is the second button. The rest of this page explains every part, slowly.",
  ...
  camera: "The camera is your home. There is no small microphone button to find. Hold anywhere on the picture. When it hears you, it says Listening. Let go when you finish talking. Double tap starts object detection. Double tap again stops it. At the bottom, six buttons: camera, emergency, contacts, profile, plans, and settings. Walking is not a button. Say take me to a place.",
  ...
  call: "Calling stays inside AI Sight. Family is one group. When you call, everyone rings. Anyone who is free can pick up. A helper should open Settings once and tap Configure calling. Then hold and say: call. Or: video call. Green answers. The call can keep ringing other people if one person declines.",
  ...
  emergency: "This is the most important help. If you only say emergency, or SOS, the app does everything at once. It starts a video call to your group and admin. It sends a message. It sends a photo. It sends a map. Anyone who is free can pick up. If you want only one thing, say emergency send a message, or emergency send a photo, or emergency send a map. This does not replace police or ambulance numbers on the phone.",
