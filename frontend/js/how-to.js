...
const LESSONS = {
  ...
  emergency: "Tap the emergency button to open emergency chat with admin. You can text, send a voice note, send a photo, or send a map. Call and video call are at the top. They ring admin, not family, and they use the in-app video call, not a phone number. If a blind person says emergency, or SOS, the app starts an in-app video call and sends a message, a photo, and a map to admin at once. If you want only one thing, say emergency send a message, or emergency send a photo, or emergency send a map. This does not replace police or ambulance numbers on the phone.",
