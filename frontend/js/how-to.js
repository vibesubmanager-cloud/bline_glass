...
const LESSONS = {
  ...
  emergency: "Tap the emergency button to open emergency chat with admin. You can text, send a voice note, send a photo, or send a map. Call and video call go to the home camera screen so a blind person does not have to change pages. If a blind person says emergency, or SOS, the app stays on the camera, takes a picture of what is in front of them right then, sends their map, and sends I need help now, then starts the in-app video call on that same home screen. When admin leaves, the call ends and the live camera comes back. If you want only one thing, say emergency send a message, or emergency send a photo, or emergency send a map. This does not replace police or ambulance numbers on the phone.",
  ...
  call: "Calling stays inside vibeEye, on the home camera screen. It does not open another page. Family is one group. When you call, everyone rings. Anyone who is free can pick up. When they leave, the call ends and the live camera comes back. A helper should open Settings once and tap Configure calling. Then hold and say: call. Or: video call. Green answers.",
